...
Terraform is often referred to as “Infrastructure as Code (IaC)” or more precisely **API as Code**, because it interacts directly with cloud provider APIs to provision and manage infrastructure. AWS CloudFormation (CFT) and Azure Resource Manager (ARM templates)are also Infrastructure as Code tools, but they are cloud-specific.
